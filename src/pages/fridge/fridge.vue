        ...
        <div class="scrollerInfo">
          ...
          <div v-show="num==0" class="scrollerCon">
            <vue-drop
              ...
              :animation ="info.lInfo.animation"
            >
              <div id="lInfo">
          ...
          <div class="scrollerCon" v-show="num===1">
            <vue-drop
              ...
              :sort="info.lfun.sort"
              :onStart="info.lfun.onStart"
              :animation ="info.lfun.animation"
            >
        ...
        <div class="mobileBox">
          ...
          <div class="assemblyInfo themeColor">
            <vue-drop
              ...
              :animation="info.rInfo.animation"
            >
              <div class="temperatureBox" id="rInfo">
                ...
                >
                  <ul
                    class="scrollerAssembly item clearfix"
                    data-type="header"
                  ...
                  >
                    ...
                    <!-- 删除 -->
                    <div class="r-mask" v-if="selectType === 'header' || hoverType === 'header'">
                      <div class="border"  v-show="selectType === 'header'"></div>
                      <div class="del-circle js-remove">
                        <div class="del-line"></div>
                        <div class="del-line del-line-rotate"></div>
                      </div>
                    </div>
                  </ul>
                </template>
          ...
          <vue-drop
            ...
            :animation="info.rfun.animation"
          >
            <div class="functionAssembly mh100" id="rfun">
              <!--设备组件-->
              <template
                v-if="submitData && submitData.data.power && submitData.data.power.is_show"
              >
                <div
                  class="deviceStatus item"
                  data-type="power"
                  @mouseenter="enter($event)"
                  @mouseleave="leave($event)"
                >
                  <div
                    class="title"
                  >
                    {{submitData && submitData.data.power && submitData.data.power.title ? submitData.data.power.title : null}}
                  </div>
                  <button class="icon-power"></button>
                  <!-- 删除 -->
                  <div class="r-mask" v-if="selectType === 'power' || hoverType === 'power'">
                    <div class="border"  v-show="selectType === 'power'"></div>
                    <div class="del-circle js-remove">
                      <div class="del-line"></div>
                      <div class="del-line del-line-rotate"></div>
                    </div>
              ...
              >
                ...
                >
                  <div
                    class="title"
                  >
                    {{submitData && submitData.data.counter && submitData.data.counter.title ? submitData.data.counter.title : null}}
                  </div>
                  <div class="number">--</div>
                  <div class="only-btn">
                    <button class="icon-plus"></button>
                  ...
                  <!-- 删除 -->
                  <div class="r-mask" v-if="selectType === 'counter' || hoverType === 'counter'">
                    <div class="border" v-show="selectType === 'counter'"></div>
                    <div class="del-circle js-remove">
                      <div class="del-line"></div>
                      <div class="del-line del-line-rotate"></div>
                    </div>
              ...
              <!--模式设置组件-->
              <template
                v-if="submitData && submitData.data.modes && submitData.data.modes.is_show"
              >
                <div
                  class="patternSetting item"
                  data-type="modes"
                  @mouseenter="enter($event)"
                  @mouseleave="leave($event)"
                >
                  <div
                    class="title"
                  >
                    {{submitData && submitData.data.modes && submitData.data.modes.title ? submitData.data.modes.title : null}}
                  </div>
                  <ul class="patternList">
                    <li
                  ...
                  <!-- 删除 -->
                  <div class="r-mask" v-if="selectType === 'modes' || hoverType === 'modes'">
                    <div class="border" v-show="selectType === 'modes'"></div>
                    <div class="del-circle js-remove">
                      <div class="del-line"></div>
                      <div class="del-line del-line-rotate"></div>
                    </div>
              ...
              >
                ...
                >
                  <div
                    class="title"
                  >
                    {{submitData && submitData.data.windRang && submitData.data.windRang.title ? submitData.data.windRang.title : null}}
                  </div>
                  <div class="windSpeed">
                    <div class="slider-button"></div>
                    <ul class="windSpeed-list">
                  ...
                  <!-- 删除 -->
                  <div class="r-mask" v-if="selectType === 'windRang' || hoverType === 'windRang'">
                    <div class="border" v-show="selectType === 'windRang'"></div>
                    <div class="del-circle js-remove">
                      <div class="del-line"></div>
                      <div class="del-line del-line-rotate"></div>
                    </div>
              ...
              >
                <div
                  class="panelAssembly item"
                  data-type="screenDisplay"
                  @mouseenter="enter($event)"
                  @mouseleave="leave($event)"
                >
                  <div class="title">
                    {{submitData && submitData.data.screenDisplay && submitData.data.screenDisplay.title ? submitData.data.screenDisplay.title : null}}</div>
                  <div class="switch-off">
                    <span class="switch-button"></span>
                  </div>
                  <!-- 删除 -->
                  <div class="r-mask" v-if="selectType === 'screenDisplay' || hoverType === 'screenDisplay'">
                    <div class="border" v-show="selectType === 'screenDisplay'"></div>
                    <div class="del-circle js-remove">
                      <div class="del-line"></div>
                      <div class="del-line del-line-rotate"></div>
                    </div>
              ...
              <template v-if="submitData && submitData.data.mute && submitData.data.mute.is_show">
                ...
                >
                  ...
                  <!-- 删除 -->
                  <div class="r-mask" v-if="selectType === 'mute' || hoverType === 'mute'">
                    <div class="border" v-show="selectType === 'mute'"></div>
                    <div class="del-circle js-remove">
                      <div class="del-line"></div>
                      <div class="del-line del-line-rotate"></div>
                    </div>
              ...
              <template v-if="submitData && submitData.data.sleep && submitData.data.sleep.is_show">
                ...
                >
                  ...
                  <!-- 删除 -->
                  <div class="r-mask" v-if="selectType === 'sleep' || hoverType === 'sleep'">
                    <div class="border" v-show="selectType === 'sleep'"></div>
                    <div class="del-circle js-remove">
                      <div class="del-line"></div>
                      <div class="del-line del-line-rotate"></div>
                    </div>
    ...
    .functionAssembly{
      .item {
        ...
        .r-mask{
          ...
          left: 0;
          right: 0;
          background-color: rgba(255,119,89,.3);
          z-index: 10;
          .border{
            // width: 100%;
            height: 100%;
          ...
          .del-circle{
            ...
            box-shadow: 0 6px 10px 0 #ff502a;
            .del-line{
              position: absolute;
              top: 6px;
              right: 11px;
